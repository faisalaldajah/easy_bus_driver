// ignore_for_file: prefer_const_constructors_in_immutables, use_key_in_widget_constructors, prefer_final_fields, prefer_collection_literals, prefer_const_constructors, prefer_const_literals_to_create_immutables, avoid_unnecessary_containers, avoid_print, avoid_function_literals_in_foreach_calls
import 'dart:async';
import 'dart:io';
...
class _NewTripPageState extends State<NewTripPage> {
  ...
  void acceptTrip() {
    ...
    rideRef.child('car_details').set(
        '${currentDriverInfo.socialDriverNumber} - ${currentDriverInfo.busType}');
